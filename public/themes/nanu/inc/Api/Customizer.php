...
use Nanu\Api\Customizer\Sidebar;
use Nanu\Api\Customizer\Header;
use Nanu\Api\Customizer\Footer;
...
class Customizer
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'nanu_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'nanu_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'nanu_header_background_color' );
			echo self::css( '.site-header', 'color', 'nanu_header_text_color' );
			echo self::css( '.site-header a', 'color', 'nanu_header_link_color' );
