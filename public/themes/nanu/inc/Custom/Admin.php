...
use Nanu\Api\Settings;
use Nanu\Api\Callbacks\SettingsCallback;
...
class Admin
{
	...
	private function enqueue()
	{
		...
		$pages = array( 'toplevel_page_nanu' );
	...
	private function enqueue_faq( Settings $settings )
	{
		...
		// Pages array to where enqueue scripts
		$pages = array( 'nanu_page_nanu_faq' );
	...
	private function settings()
	{
		...
		$args = array(
			array(
				'option_group' => 'nanu_options_group',
				'option_name' => 'first_name',
				'callback' => array( $this->callback, 'nanu_options_group' )
			),
			array(
				'option_group' => 'nanu_options_group',
				'option_name' => 'nanu_test2'
			)
		);
	...
	private function sections()
	{
		...
		$args = array(
			array(
				'id' => 'nanu_admin_index',
				'title' => 'Settings',
				'callback' => array( $this->callback, 'nanu_admin_index' ),
				'page' => 'nanu'
			)
		);
